...
module.exports = {
    ...
    run: function(creep) {
	    ...
	    if(walls.length) {
			...
			if(Memory.rooms[creep.room.name] != undefined && Memory.rooms[creep.room.name].wallMinHealth != undefined) {
				wallMinHealth = Memory.rooms[creep.room.name].wallMinhealth;
			}
