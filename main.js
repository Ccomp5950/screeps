...
var roles =            {harvester:      {namer:"harvester",             minimum:2,      requirement:0,          buildRestriction : false,       run: require('role.harvester')},
			...
			remoteminer:	{namer:"remoteminer",		minimum:1,	requirement:900,	buildRestriction : true,	run: require('role.miner')},
			remotefetcher:	{namer:"remotefetcher",         minimum:1,      requirement:1400,       buildRestriction : true,        run: require('role.fetcher')},
