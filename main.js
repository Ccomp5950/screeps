...
var roles =            {harvester:      {namer:"harvester",             minimum:2,      requirement:0,          buildRestriction : false,       run: require('role.harvester')},
			...
			remoteminer:	{namer:"remoteminer",		minimum:2,	requirement:900,	buildRestriction : true,	run: require('role.miner')},
			remotefetcher:	{namer:"remotefetcher",         minimum:2,      requirement:1400,       buildRestriction : true,        run: require('role.fetcher')},
			...
			towerdrainer:	{namer:"towerdrainer",		minimum:1,	requirement:1860,	buildRestriction : true,	run: require('role.towerdrainer')},
			healer:         {namer:"healer",                minimum:1,      requirement:1500,	buildRestriction : true,        run: require('role.healer')}
                        };
